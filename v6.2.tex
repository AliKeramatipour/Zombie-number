...
The Cartesian product $G \square H$ of two graphs $G$ and $H$, is a graph with vertex set of $V(G) V(H)$, where
...
\section{Zombie Capture time Problem is NP-Hard}\label{np-capturetime}
	...
	\begin{proof}
		...
		recall the $G$-subgraph simply as $G$ and $i$-th $(1 \leq i \leq n)$ bipartite subrgraph as $K_i$ . We name the
